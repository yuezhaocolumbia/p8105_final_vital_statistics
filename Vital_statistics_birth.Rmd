...
```{r}
# community district
birth2000 = haven::read_sas("./data/community_district/cdall_00.sas7bdat")
names(birth2000)
```
...
```{r}
# zip code
birth9901 = haven::read_sas("./data/zip_code/zipall_9901.sas7bdat")
names(birth9901)
```
...
```{r}
# census tract
birth0004 = haven::read_sas("./data/census_tract/tractall_0004.sas7bdat")
names(birth0004)
```
