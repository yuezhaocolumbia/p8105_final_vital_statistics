...
author: "Yi Xiao (yx2510) | Xue Yang (xy2397) | Kangkang Zhang (kz2334) | Yue Zhao (yz3297)"
date: "05/12/2018"
...
## 4. Birth data 
### 4.1 Data tidy
#### Load and clean the birth data from community_district source
...
The community_district dataset contains `r nrow(birth_data_un)` rows x `r ncol(birth_data_un)` columns, with each row representing a corresponding birth record from year 2000 to 2014 in different community district in New York City. Each varaible in the column records number of subjects falling into that specific category.Since the dataset is large, we decided to split the dataset into several subsets and examine those individual and crossed variables separately. 
